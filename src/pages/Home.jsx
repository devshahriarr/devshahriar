...
const Home = () => {
  const { heroData, projectsData, aboutData, serviceData, skillData, portfolioData, blogData, resumeData, reviewData, contactData, socialData, myskill } = data;
  return (
    <>
      <div className="st-height-b80 st-height-lg-b80"></div>
      <Hero data={heroData.homeOneHero} socialData={socialData} />
      <About data={aboutData} data-aos="fade-right" />
      <MySkill data={myskill} data-aos="fade-right" />
      ...
      <ProjectSection data={projectsData} data-aos="fade-right" />
