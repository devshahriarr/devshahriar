        ...
        <div className="container">
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <Link className="st-site-branding" to='home' id="hero"><img src="/images/logo.png" alt="Shahriar Hossain Jihad" /></Link>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                <ul className="st-nav-list st-onepage-nav" style={{ display: `${mobileToggle ? 'block' : 'none'}` }}>
                  ...
                  <li><ScrollLink to="skill" spy={true} smooth={true} offset={-80} duration={500} onClick={() => setMobileToggle(false)}>Skill</ScrollLink></li>
                  ...
                  <li><ScrollLink to="projects" spy={true} smooth={true} offset={-80} duration={500} onClick={() => setMobileToggle(false)}>Projects</ScrollLink></li>
                ...
                <div className="sp-phone">
                  ...
                  <div className="sp-phone-no">+880 13068 91479</div>
                </div>
              </div>
            </div>
          </div>
