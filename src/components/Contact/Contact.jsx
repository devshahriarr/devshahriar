  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        ...
        form.current,
        import.meta.env.VITE_REACT_APP_EMAILJS_PUBLIC_KEY // Replace with your EmailJS Public Key
      )
      .then(
        (result) => {
          console.log(result);
            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                  <Link to="#">devshahriarr@gmail.com</Link>
                  <Link to="#">info@devshahriar.com</Link>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
                ...
                <div className="st-single-info-details">
                  <h4>Phone</h4>
                  <span>+880 1306891479</span>
                  <span>+880 1742735416</span>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
